...
const checks = [
  ...
  ['source flow', '/src/main.jsx', ['controlled hike flow', 'PlanFlow', 'DirectionFlow', 'PrepFlow', 'HikeFlow', 'ReviewFlow', 'ProfileFlow']],
  ['source saves/weather/layers', '/src/main.jsx', ['Save profile', 'Refresh last-known weather', 'Save route', 'FEATURE_DEFINITIONS', 'WATER_REPORTS', 'ALT_ROUTE_LIBRARY', 'Show help indicators', 'attributionControl: false']],
  ['styles flow/layers', '/src/styles.css', ['flow-grid', 'flow-tabs', 'save-toast', 'layer-panel', 'help-tip', 'direction-step', 'map-feature-icon', 'leaflet-control-attribution', '.real-map .leaflet-pane svg']],
];
let failed = 0;
